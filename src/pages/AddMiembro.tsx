...
import { Miembro } from '../model/Miembro.interface';
...
const AddMiembro = () => {
  ...
  const { addMiembro } = useContext(MiembroContext)
  ...
  return (
    <div className='container'>
      <p className='h3 text-center my-3'>Registrar</p>
      <div className="row">
        <div className="col shadow rounded">
          ...
          <div className="d-grid my-3">
            <button onClick={handleAdd} className="btn btn-dark">Registrar</button>
          </div>
        </div>
      </div>
    </div>
